        ...
        <div class="container-fluid bg-dark px-5 d-none d-lg-block">
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.html" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fas fa-star-of-life me-3"></i>Fasilitas Kesehatan </h1>
                    <!-- <img src="{{asset('assets/img/carousel-1.jpg')}}" alt="Logo"> -->
                </a>
                ...
                <div class="header-carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="carousel-caption-content p-3">
                            ...
                            <h1 class="display-1 text-capitalize text-white mb-4">Direktori Fasilitas kesehatan</h1>
                            <p class="mb-5 fs-5"> 
                            </p>
                ...
                <div class="header-carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="carousel-caption-content p-3">
                            ...
                            <h1 class="display-1 text-capitalize text-white mb-4">The best solution for managing health facilities data </h1>
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <h1 class="display-3 mb-4">We handle the storage of healthcare facilities</h1>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-img pb-5 ps-5">
                            <img src="{{asset('assets/img/about-1.jpg')}}" class="img-fluid rounded w-100" style="object-fit: cover;" alt="Image">
                            <div class="about-img-inner">
                                <img src="{{asset('assets/img/about-2.jpg')}}" class="img-fluid rounded-circle w-100 h-100" alt="Image">
                            </div>
